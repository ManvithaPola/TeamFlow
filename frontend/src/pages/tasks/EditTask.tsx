...
import type { UpdateTaskRequest, Priority } from "../../types/task.types";
...
const EditTask = () => {
  ...
  useEffect(() => {
    const loadMembers = async () => {
      ...
      const data = await getMembers(task.projectId);
  ...
  const handleChange = <K extends keyof UpdateTaskRequest>(
    field: K,
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-slate-500">
                Update task information, assignment, priority and planning
                details.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-6 sm:px-10">
            ...
            >
              <span className="mr-auto hidden text-sm text-slate-400 sm:block">
                Save your changes to update this task.
              </span>
